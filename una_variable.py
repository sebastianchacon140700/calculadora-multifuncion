...
from logicas.historial import (leer_historial_una,guardar_historial_una)
...
class PanelUnaVariable(wx.Panel):
   ...
   # Lógica de enrutamiento
    ...
    # Eventos de botones 
        ...
        self.combo_destino.Bind( wx.EVT_COMBOBOX,self.seleccionar_destino )
    ...
    def limpiar(self, event):       #Reinicia los campos del formulario.
        ...
        self.label.SetLabel("Selecciona una unidad de origen e ingresa un valor")
...
class VentanaUnaVariable(wx.Frame):
    ...
    def __init__(self, parent = None):
        """Inicia la ventana, configura el menú y vincula los eventos."""
        super().__init__( parent,title='convertidor de unidades',size=(850, 550))
        self.parent = parent
    ...
    def ver_historial(self, event):
        ...
        wx.MessageBox(historial,"Historial de conversiones", wx.OK | wx.ICON_INFORMATION )
